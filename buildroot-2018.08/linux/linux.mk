...
LINUX_TARGET_CROSS = $(call qstrip,$(BR2_LINUX_KERNEL_OVERRIDE_CROSS))
ifeq ($(LINUX_TARGET_CROSS),)
LINUX_TARGET_CROSS=$(TARGET_CROSS)
endif

LINUX_KERNEL_ARCH=$(call qstrip,$(BR2_LINUX_KERNEL_OVERRIDE_ARCH))
ifeq ($(LINUX_KERNEL_ARCH),)
...
LINUX_MAKE_FLAGS = \
	...
	CROSS_COMPILE="$(LINUX_TARGET_CROSS)" \
...
LINUX_IMAGE_INSTALL_NAME = $(call qstrip,$(BR2_LINUX_KERNEL_IMAGE_INSTALL_NAME))
ifeq ($(LINUX_IMAGE_INSTALL_NAME),)
LINUX_IMAGE_INSTALL_NAME = $(LINUX_IMAGE_NAME)
endif
...
LINUX_ARCH_PATH = $(LINUX_DIR)/arch/$(LINUX_KERNEL_ARCH)
endif
...
# build process.
define LINUX_INSTALL_IMAGE
	$(INSTALL) -m 0644 -D $(LINUX_IMAGE_PATH) $(1)/$(LINUX_IMAGE_INSTALL_NAME)
endef
endif
