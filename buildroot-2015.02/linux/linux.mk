...
LINUX_KERNEL_CONFIG_FRAGMENT_FILES = $(call qstrip,$(BR2_LINUX_KERNEL_CONFIG_FRAGMENT_FILES))
...
define LINUX_CONFIGURE_CMDS
	...
	$(if $(LINUX_KERNEL_CONFIG_FRAGMENT_FILES),
		$(TOPDIR)/support/kconfig/merge_config.sh -m -O $(@D) $(@D)/.config $(LINUX_KERNEL_CONFIG_FRAGMENT_FILES))
...
define LINUX_INSTALL_IMAGES_CMDS
	cp $(LINUX_IMAGE_PATH) $(BINARIES_DIR)/$(LINUX_IMAGE_INSTALL_NAME)
	$(LINUX_INSTALL_DTB)
endef
